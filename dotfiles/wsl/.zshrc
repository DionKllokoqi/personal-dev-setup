...
plugins=(git gh dotnet dotenv fzf autojump zsh-autosuggestions zsh-autocomplete fast-syntax-highlighting)
...
# Go path for go executable and installed tools
...
[[ -f ~/.dotfiles/lib/zsh-autoenv/autoenv.zsh ]] && source ~/.dotfiles/lib/zsh-autoenv/autoenv.zsh
